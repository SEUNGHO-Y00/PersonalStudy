...
## 1. Why Automate OS Commands in Defensive Security?

## 2. Methods to Execute Commands in Python

### 2.1 Using os.system()

### 2.2 Using subprocess.run()

## 3. Real-Time Output with subprocess.Popen
